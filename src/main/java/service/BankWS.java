 ...
 * 
 */
@WebServiceClient(name = "BankWS", targetNamespace = "http://service.example.org/", wsdlLocation = "http://localhost:8585/?WSDL")
public class BankWS
    extends Service
{
    ...
    private final static QName BANKWS_QNAME = new QName("http://service.example.org/", "BankWS");
    ...
    public BankService getBankServicePort() {
        return super.getPort(new QName("http://service.example.org/", "BankServicePort"), BankService.class);
    }
    ...
    public BankService getBankServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.example.org/", "BankServicePort"), BankService.class, features);
    }
